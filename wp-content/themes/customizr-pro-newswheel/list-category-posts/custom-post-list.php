...
$lcp_display_output .= '<ul class="posts_catlist">';
...
while ( have_posts() ):
  ...
  $lcp_display_output .= "<li class='lcp_item'>";

  //Show the title and link to the post:
  $lcp_display_output .= $this->get_post_title($post, 'div', 'lcp_post');
  ...
  //Show date modified:
  $lcp_display_output .= ' ' . $this->get_modified_date($post, 'span', 'lcp_modified');
  ...
  //Post Thumbnail
  $lcp_display_output .= $this->get_thumbnail($post, 'div class="lcp_thumb"');
