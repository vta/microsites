...
use Demo_Print\Core\Route_Type as Route_Type;
...
|		>with_controller( 'Admin_Settings' ) // Resolved by Router to 'Demo_Print\App\Controllers\Admin\Admin_Settings'.
|		->with_model( 'Admin_Settings' ) // Resolved by Router to 'Demo_Print\App\Models\Admin\Admin_Settings'.
|		->with_view( 'Admin_Settings' ); // Resolved by Router to 'Demo_Print\App\Views\Admin\Admin_Settings'.
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_controller( 'Demo_Print\App\Controllers\Admin\Admin_Settings' )
|		->with_model( 'Demo_Print\App\Models\Admin\Admin_Settings' )
|		->with_view( 'Demo_Print\App\Views\Admin\Admin_Settings' );
|-------------------------------------------------------------------------------------------
*/
...
|	$router
|		->register_route_of_type( ROUTE_TYPE::ADMIN )
|		->with_just_model('Demo_Print_Model_Admin_Settings');
|-------------------------------------------------------------------------------------------
*/
...
$router
	->register_route_of_type( ROUTE_TYPE::ADMIN )
	->with_controller( 'Admin_Settings@register_hook_callbacks' ) // Resolved by Router to 'Demo_Print\App\Controllers\Admin\Admin_Settings'.
	->with_model( 'Admin_Settings' ) // Resolved by Router to 'Demo_Print\App\Models\Admin\Admin_Settings'.
	->with_view( 'Admin_Settings' ); // Resolved by Router to 'Demo_Print\App\Views\Admin\Admin_Settings'.
...
$router
	...
	->with_controller( 'Demo_Print\App\Controllers\Frontend\Print_Posts_Shortcode@register_shortcode' )
	->with_model( 'Demo_Print\App\Models\Frontend\Print_Posts_Shortcode' );
