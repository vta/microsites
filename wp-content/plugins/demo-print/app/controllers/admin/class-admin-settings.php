...
use Demo_Print\App\Controllers\Admin\Base_Controller;
...
if ( ! class_exists( __NAMESPACE__ . '\\' . 'Admin_Settings' ) ) {
	 ...
	 * @since      1.0.0
	 * @package    Demo_Print
	 * @subpackage Demo_Print/controllers/admin
	 */
	class Admin_Settings extends Base_Controller {
		 ...
		 * @since 1.0.0
		 */
		private static $hook_suffix = 'settings_page_' . Demo_Print::PLUGIN_ID;
		...
		public function register_hook_callbacks() {
			...
			add_filter(
				'plugin_action_links_' . Demo_Print::PLUGIN_ID . '/' . Demo_Print::PLUGIN_ID . '.php',
		...
		public function plugin_menu() {
			...
			static::$hook_suffix = add_options_page(
				__( Demo_Print::PLUGIN_NAME, Demo_Print::PLUGIN_ID ),        // Page Title.
				__( Demo_Print::PLUGIN_NAME, Demo_Print::PLUGIN_ID ),        // Menu Title.
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_script(
				Demo_Print::PLUGIN_ID . '_admin-js',
				Demo_Print::get_plugin_url() . 'assets/js/admin/demo-print.js',
				array( 'jquery' ),
				Demo_Print::PLUGIN_VERSION,
				true
			);
		}
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style(
				Demo_Print::PLUGIN_ID . '_admin-css',
				Demo_Print::get_plugin_url() . 'assets/css/admin/demo-print.css',
				array(),
				Demo_Print::PLUGIN_VERSION,
				'all'
			);
		...
		public function markup_settings_page() {
			if ( current_user_can( static::REQUIRED_CAPABILITY ) ) {
				$this->view->admin_settings_page(
					array(
						'page_title'    => Demo_Print::PLUGIN_NAME,
		...
		public function register_fields() {
			...
			add_settings_section(
				'demo_print_section',                    // Section ID.
				__( 'Settings', Demo_Print::PLUGIN_ID ), // Section Title.
			...
			add_settings_field(
				'demo_print_field',                                // Field ID.
				__( 'Demo Print Field:', Demo_Print::PLUGIN_ID ), // Field Title.
				array( $this, 'markup_fields' ),                    // Field Callback.
				static::SETTINGS_PAGE_SLUG,                          // Page.
				'demo_print_section',                              // Section ID.
				array(                                              // Field args.
					'id'        => 'demo_print_field',
					'label_for' => 'demo_print_field',
				)
			);
		}
		...
		public function markup_section_headers( $section ) {
			$this->view->section_headers(
				array(
					'section'      => $section,
					'text_example' => __( 'This is a text example for section header', Demo_Print::PLUGIN_ID ),
				)
			);
		}
		...
		public function add_plugin_action_links( $links ) {
			$settings_link = '<a href="options-general.php?page=' . static::SETTINGS_PAGE_SLUG . '">' . __( 'Settings', Demo_Print::PLUGIN_ID ) . '</a>';
