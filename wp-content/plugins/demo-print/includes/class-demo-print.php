<?php
use Demo_Print\Includes\i18n;
use Demo_Print\Includes\Dependency_Loader;
use Demo_Print\Core\Registry\Controller as Controller_Registry;
use Demo_Print\Core\Registry\Controller as Model_Registry;
use Demo_Print\App\Models\Settings;

require_once plugin_dir_path( __FILE__ ) . '/class-dependency-loader.php';


if ( ! class_exists( 'Demo_Print' ) ) {
	 ...
	 */
	class Demo_Print extends  Dependency_Loader {
		 ...
		 * @since    1.0.0
		 * @access   private
		 * @var      Demo_Print    $instance    Instance of this class.
		 */
		...
		private function set_locale() {
			...
			$plugin_i18n->set_domain( Demo_Print::PLUGIN_ID );
